  ...
  return (
    ...
    >
      ...
      <div className="hero-content absolute inset-x-0 top-0 h-dvh">
        <Bounded
          fullWidth
          className="absolute inset-x-0 top-18 md:top-18 md:left-[8vw]"
        >
          <PrismicRichText
            field={slice.primary.heading}
            components={{
              heading1: ({ children }) => (
                <h1 className="hero-heading font-black-slanted text-6xl leading-[0.8] uppercase sm:text-7xl lg:text-7xl">
                  {children}
                </h1>
              ),
            }}
        ...
        <Bounded
          fullWidth
          className="hero-body absolute inset-x-0 bottom-0 mb-1 md:right-[8vw] md:left-auto"
